...
export function PartModal({
  ...
  const slotHints = {
    ...
    pickupConfiguration: 'Sets the pickup layout (HH, H-S-H).',
    pickupColor: 'Sets the pickup color style (bobbins, painted, wooden, covers).',
    pickupColorVariant: 'Sets the specific color variant for the pickup.',
    pickupPaintedColor: 'Sets the RGB painted color for the pickup.',
    pickupWoodType: 'Sets the wood type for wooden bobbins.',
